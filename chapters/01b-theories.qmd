...
::: {.thought-question}
Plague reached Sicily in the autumn of 1347 and the Italian mainland that winter, then moved north city by city. Florence and Milan both knew it was coming, and both already believed it travelled with the sick, their belongings, and travellers from infected towns.

**Florence** did not act until the plague was already inside its walls, and could not enforce what it then ordered. It buried half its people, and possibly far more.

**Milan** sealed its gates early. When plague appeared in three houses, the ruling archbishop had them walled up with the occupants still inside, the healthy along with the sick and the dead. Milan came through comparatively lightly.

- You advise one of these cities before the plague arrives. Which policy do you adopt?
- You live in Milan and wake with a fever. Do you tell anyone?
- What would a good neighbor do, in either city?
:::

::: {.aside-note}
**Sources and caveats.** The walling-up is Barbara Tuchman's account, which credits Archbishop Giovanni Visconti; she draws no causal conclusion from it, writing only that "whether or not owing to his promptitude, Milan escaped lightly in the roll of the dead" [@tuchman1978]. Milan's escape was noticed at the time: the Florentine chronicler Matteo Villani recorded that the pestilence took the whole peninsula "with the exception of Milan and some Alpine districts of northern Lombardy" [@gasquet1893]. How much of that was policy, and how much Milan's inland position and thinner sea trade, is unsettled. Florence was not idle, but it was late: its measures came in April 1348, after its first cases in March, and included a 500-lire fine on arrivals from Genoa and Pisa, a ban on selling the clothing of the sick, street clearing, and a magistracy with emergency powers [@henderson1992]. Estimates of Florentine mortality range from about half to four-fifths; the city's population is usually put near 110,000 before the plague and about 50,000 by 1351. Benedictow is the standard survey of the mortality evidence [@benedictow2021].
:::

## Three Kinds of Reason

Each of those questions asks for a different kind of reason:

- **How it turns out.** A policy is judged by its results, meaning how many people lived under it. Milan's death toll was lower than Florence's.
- **What you owe.** Some acts are wrong whatever they achieve. Sealing healthy people into a house uses them to protect other people.
- **Who you would be.** The question is what a decent person does. In Milan, warning your neighbors and shielding your own family pull in opposite directions.

The three do not always agree. Which kind of reason a case turns on is often disputed, and here the dispute starts with whether Milan's policy is the reason Milan survived.
...
::: {.aside-note}
These four theories reappear in almost every chapter that follows. Abortion, end of life, justice — each one sets them pulling in different directions. Noticing *which* theory is doing the work in an argument is half of reading it well.
:::
...
::: {.column width="24%"}
![John Stuart Mill](../images/mill.jpg){width="100%" fig-alt="Photograph of John Stuart Mill"}
:::
...
::: {.column width="26%"}
![Jeremy Bentham](../images/bentham.jpg){width="100%" fig-alt="Portrait of Jeremy Bentham"}
:::
...
::: {.aside-note}
Singer matters precisely because he refuses to stop where intuition gets uncomfortable. This is the hinge of the chapter: the next section asks whether "follow the calculation wherever it leads" is the right method at all.
:::
...
::: {.column width="42%"}
![Immanuel Kant](../images/kant.jpg){width="80%" fig-alt="Painted portrait of Immanuel Kant"}
:::
...
::: {.column width="42%"}
![Aristotle](../images/aristotle.jpg){width="80%" fig-alt="Marble bust of Aristotle"}
:::
...
::: {.column width="57%"}
- Care ethics treats responsiveness — attentiveness, responsibility — as a cultivated **trait**, like an Aristotelian virtue, not a rule to apply.
- **Gilligan** [@gilligan1982]: the dominant theories prioritize **abstract rules** for strangers, and so missed a whole moral "voice."
- **Held** [@held2006] built that into a full account in which **relationship and dependency** are morally basic.
...
::: {.column width="40%"}
![Carol Gilligan](../images/gilligan.jpg){width="80%" fig-alt="Photograph of Carol Gilligan"}
:::
...
::: {.column width="22%"}
![Confucius](../images/confucius.jpg){width="80%" fig-alt="Tang Dynasty drawing of Confucius"}
:::
...
Return to the choice between Florence's policy and Milan's. Which kind of reason carried the most weight for you, and does it still?
