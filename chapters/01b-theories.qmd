...
> "Actions are right in proportion as they tend to promote happiness; wrong as they tend to produce the reverse of happiness." — Mill [@mill1863]
...
## Kantian Ethics: Duty as Constraint and Guide

```{dot}
//| fig-width: 9
//| fig-height: 2.8
//| fig-cap: "Kantian decision procedure. Amber diamonds are perfect duties — hard stops that hold regardless of outcome. The slate diamond is an imperfect duty, which allows latitude in how and when to act."
digraph kant {
  rankdir=LR;
  bgcolor="transparent";
  ...
  A  [label="Proposed Action\n(e.g., withhold diagnosis)",
      shape=box, style="rounded,filled", fillcolor="#e6f1f2", color="#0e7c86"];

  Q1 [label="Treats patient as\nmere means?",
      shape=diamond, style=filled, fillcolor="#fff3cd", color="#b07d1a"];
  W1 [label="IMPERMISSIBLE\n(perfect duty)",
      shape=box, style="rounded,filled", fillcolor="#fad7d2",
      color="#c0392b", fontcolor="#9d2f23", penwidth=2];

  Q2 [label="Other perfect\nduty violated?",
      shape=diamond, style=filled, fillcolor="#fff3cd", color="#b07d1a"];
  W2 [label="IMPERMISSIBLE\n(perfect duty)",
      shape=box, style="rounded,filled", fillcolor="#fad7d2",
      color="#c0392b", fontcolor="#9d2f23", penwidth=2];

  Q3 [label="Imperfect duty\nto act?",
      shape=diamond, style=filled, fillcolor="#dfe6ee", color="#475569"];
  Act  [label="ACT\n(with latitude)",
        shape=box, style="rounded,filled",
        fillcolor="#e6f1f2", color="#0e7c86", fontcolor="#0e7c86", penwidth=2];
  Omit [label="May omit",
        shape=box, style="rounded,filled", fillcolor="#f8fafc", color="#94a3b8"];

  A  -> Q1;
  Q1 -> W1  [label="Yes", color="#c0392b", fontcolor="#c0392b"];
  Q1 -> Q2  [label="No"];
  Q2 -> W2  [label="Yes", color="#c0392b", fontcolor="#c0392b"];
  Q2 -> Q3  [label="No"];
  Q3 -> Act  [label="Yes"];
  Q3 -> Omit [label="No"];
...
> "The moral problem arises from conflicting responsibilities rather than competing rights and requires for its resolution a mode of thinking that is contextual and narrative rather than formal and abstract."
