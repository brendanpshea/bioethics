...
::: {.thought-question}
In 1348 plague moved up the Italian peninsula city by city. Florence and Milan each had months of warning, and each already acted on the belief that the disease travelled with the sick, their goods, and travellers from infected towns.

**Florence** issued regulations and could not enforce them. It buried perhaps half its people.

**Milan** sealed its gates early, and when plague appeared in a house, chroniclers report the house was walled up with everyone still inside — the sick and the healthy together. Milan came through comparatively lightly.
...
::: {.aside-note}
Florence was not passive: it barred goods and travellers from Genoa and Pisa in January 1348 and seated a sanitation commission that spring. The difference from Milan was enforcement, not the existence of rules. Neither city knew about *Yersinia pestis*, fleas, or rats; both acted on the older idea that disease travelled with the sick and their belongings. How much of Milan's lower toll came from its policy, and how much from its inland position and thinner sea trade, is still argued, and medieval population figures for Milan are weak.
:::
