...
::: {.thought-question}
Before anything else — **ninety seconds**, on your own.
...
::: {.thought-question}
Three of these six get a bed.

1. Which three, and why those three?
2. What is the **rule** behind your choice — a sentence someone else could apply to a different six patients?
3. Could that rule be defended out loud to the families of the other three?

No further information is available. This is everything the doctors had.
:::

## Five Rules on the Table

::: {.callout-note}
Each of these is defensible. Each one quietly assumes something.
...
::: {.thought-question}
Same six people, with the files open.

1. Does this information change the three? Be honest about whether it does.
2. If it changes the answer, which single fact did the work?
...
- **Did any name change?** If so, the file did work that the medical facts could not.
- **Could the envelope be refused** — could you decide the extra information should not be used, once it is already in front of you?

Nobody asked for these facts. They cannot now be un-known.
:::
...
# The Words Behind the Rules {.section-divider}

## Four Words That Keep Coming Back

The rules on the table have names. Four run through nearly every argument in this course:
...
None of these requires a philosophy course. They are the vocabulary people already argue in. Next week we give them sharp edges, and find where they contradict one another.
...
Does that fact belong in the decision?
:::
...
::: {.thought-question}
These two agree about almost everything. Find the **one** premise where they part.
:::
...
| **18–20** | Read it back. Cut one sentence that is not working. |
:::
...
Those four moves are the whole of the planning step, run here on a question nobody has settled.

Read the full case study before our next meeting. Then we start on the four words above.
:::
