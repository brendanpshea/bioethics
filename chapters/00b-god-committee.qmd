...
::: {.column width="56%"}
A hospital basement in Seattle holds the only machine in the world that can keep a person with dead kidneys alive indefinitely. It serves **three patients at a time**.

In the surrounding region, roughly **sixty people** will die this year of kidney failure. Every one of them is medically eligible. The machine cannot be shared, stretched, or borrowed.

Somebody has to pick. For the next hour, that somebody is you.
:::
...
::: {.context-box}
These six are **composites** — invented people, built from the kinds of facts the real 1962 files contained. The real ratio was closer to three beds for sixty candidates.
:::

| | Age | Cause of kidney failure | Without dialysis |
|---|---|---|---|
| **A** | 41 | Chronic glomerulonephritis | ~3 months |
| **B** | 27 | Congenital kidney disease | ~4 months |
| **C** | 44 | Hypertensive kidney damage | ~2 months |
| **D** | 35 | Chronic glomerulonephritis | ~3 months |
| **E** | 31 | Polycystic kidney disease | ~5 months |
| **F** | 38 | Post-infectious kidney failure | ~3 months |
...
::: {.thought-question}
Same groups. Same six people. **Eight minutes.**
