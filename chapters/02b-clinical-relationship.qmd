...
::: {.thought-question}
Mrs. R is 61, in for fatigue and weight loss. The colonoscopy found colon cancer — serious, but treatable. She is frightened, and her daughter Dana does most of the talking. Mrs. R asks: *"So what happens now?"*

Four residents tell you how they would answer her:

1. "I'd lay out all three options with the survival numbers and let her pick."
2. "I'd tell her what I'd weigh in her shoes, and why, then ask what she thinks."
3. "I'd tell her the right move is surgery and get her scheduled. She's frightened; she needs a plan."
4. "I'd ask what matters most to her — more time, or fewer side effects — before we talk options."

- You are the attending. Which resident do you back, and what do you say to the other three?
- Is any of them simply wrong, or does it depend on the patient?
:::

::: {.aside-note}
Read the four aloud, in four different voices. The *facts* never change across them; only what the clinician does with authority changes.
:::
...
# Why This Relationship Is Hard {.section-divider}
...
::: {.column width="50%"}
- **Luke Fildes**'s *The Doctor* (1891) was the most reproduced image of medicine in the English-speaking world, and for a century it was how the profession saw itself.
- The physician watches, interprets, and quietly decides. The parents wait in the shadows.
- The one person with no voice in the picture is the patient.
- The modern apparatus of consent exists to put that voice back.
:::
...
- The patient is sick, frightened, and often in pain, and the information is unequal from the first minute.
- What is at stake is rarely a technical fact. It is what kind of life is worth living, which is the patient's question.
- Ethical care does not pretend the asymmetry away. It manages it openly.
...
- [Autonomy]{.key-term} is the patient's right to make informed choices about her own body.
- [Beneficence]{.key-term} is the clinician's duty to act for her welfare.
- Most of the time they run together: good information and a good recommendation are both in her interest.
- They pull apart when what the clinician judges best is what the patient does not want.
- A competent patient's refusal is a **conflict of values**, not a misunderstanding to clear up.
...
| Model | Which resident | Main clinician role | Main risk |
|---|---|---|---|
| **Paternalistic** | 3 | Decide what is best | Patient becomes passive |
| **Informative** | 1 | Provide facts and options | Clinician becomes a vending machine |
| **Interpretive** | 4 | Help clarify the patient's values | Clinician may over-read the patient |
| **Deliberative** | 2 | Recommend and reason about values | Persuasion can slide into pressure |
...
There is no single national Tarasoff rule. There is a default ethical question — serious, specific danger to an identifiable person — that each state answers differently.
...
- The reversal took a single professional generation [@oken1961; @novack1979].
- What felt like obvious kindness was a **convention**, not a moral fact.
- Conventions about disclosure still vary across cultures, so you ask this patient rather than assume.
