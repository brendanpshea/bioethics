...
## The Being the Charge Is About

![](../images/chimpanzee_sanctuary.jpg){width="70%" fig-alt="A chimpanzee sitting in grass at the Sweetwaters Chimpanzee Sanctuary in Kenya"}

::: {.attribution}
Valentina Storti, via Wikimedia Commons. CC BY 2.0.
:::

Chimpanzees use tools, recognize themselves in mirrors, and grieve their dead. Wherever you draw the line, you have to say on which side this one falls.
...
::: {.thought-question}
The chimps are retired, but pressure on primate research is rising. During COVID-19, demand for research monkeys outstripped supply, sparking a global shortage and a scramble for sources. Meanwhile, gene-edited **pig organs** have moved past one-off rescues into FDA-cleared clinical trials, with one recipient living 271 days before receiving a human kidney — a use of animals that sidesteps the lab entirely, and now at scale.
