...
::: {.aside-note}
This is Judith Jarvis Thomson's 1971 case. We reconstruct it as an explicit argument later in the chapter.
:::
...
- **There is a moral difference between "killing" and "letting die."** Where you draw that line will decide many other cases in this course.
:::
...
- Tell *validity* from *soundness*, and spot the equivocation on "human" that runs through abortion arguments
...
## Standard Form, Recapped

Earlier in the course we treated an argument as premises plus a conclusion. Today we write them in **standard form**: numbered premises, then the conclusion.

- An argument is **valid** when the conclusion *follows*: if the premises were true, the conclusion would have to be.
- It is **sound** when it is valid *and* every premise is actually true.
- Most serious abortion arguments are valid. The fight is over whether one premise is true, so the skill is finding that premise.
...
::: {.aside-note}
Once you can see equivocation and question-begging, you hear them everywhere. These two are worth the effort: they transfer to every chapter that follows.
:::
...
::: {.aside-note}
This is a paraphrase of Marquis, not his exact words. We formalize it carefully in the next section — you will see it again.
:::
...
- About **60%** of those obtaining abortions are already mothers.
- The typical patient is in her 20s, low-income, and identifies as Christian.
- The most-cited reasons are **economic instability**, **timing**, and **responsibilities to existing children**.
- About **80%** of US abortions occur in the first trimester; **under 1%** occur after 21 weeks, almost always for severe fetal anomaly or maternal life.

::: {.aside-note}
Public images of abortion often imagine a single, young, childless patient making a quick decision. The data describe a different population: women already raising children, deciding from inside the constraints of an existing family.
:::
...
To have [moral status]{.key-term} is to count, in your own right, in moral reasoning. Each candidate criterion gives a *different* verdict on the early fetus.

| Criterion | What it means | Early fetus? | Lines up with |
|---|---|:---:|---|
| **Biological humanity** | A living member of *Homo sapiens* | **Yes** | The conservative right-to-life argument |
| **Potentiality** | Will become a person if not killed | **Yes** | Marquis |
| **Sentience** | Able to feel pleasure and pain | **No**, until ~24 weeks | Most pro-choice arguments |
| **Personhood** | Consciousness, reasoning, self-awareness | **No** | Warren |
...
::: {.context-box}
**Warren's reply** (1982): infanticide is wrong because *others* want and can care for the infant. That moves the moral weight off the infant and onto social facts.
:::

## Activity — Personhood Scoreboard
...
1. An action is right if and only if it is what a fully **virtuous** person (honest, courageous, just, practically wise) would characteristically do in the circumstances.
...
::: {.context-box}
**Hursthouse's reply:** no theory escapes this. Utilitarians must predict consequences they cannot know; Kantians must interpret maxims.
:::

## Activity — A Different Question
...
Four arguments, side by side, each with the premise its disagreement turns on.
...
Then: do your four "weakest" premises share something? If they do, that shared thing is your deepest commitment in this debate.
:::
