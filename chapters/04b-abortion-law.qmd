...
State, in your own words, the **four standard reasons** the Supreme Court gives for overturning a precedent. Then identify which of those reasons did the most work in the *Dobbs* majority opinion.
:::

::: {.review-item .review-apply}
[Apply]{.review-label}

A US state passes a law banning abortion at six weeks LMP with an exception only when the pregnant person's "life is in imminent danger." A patient with previable PPROM presents at 19 weeks with rising white-cell count but stable vitals. Reconstruct the clinician's decision as an argument with at least three premises, identify which premise the *statute* makes most contestable, and propose one statutory change that would resolve that contestability.
:::

::: {.review-item .review-debate}
[Debate]{.review-label}

Compare China's One-Child Policy and Romania's Decree 770 as examples of state demographic engineering. Both inflicted severe harms; both ultimately failed on their own terms. Is the lesson that **coercive** reproductive policy is always wrong, or only that **these** policies were wrong because of how they were carried out? Defend your view using the four principles and at least one argument from Part A.
:::
