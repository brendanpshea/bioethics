...
::: {.attribution}
Wikimedia Commons, "Gestational limits for elective abortion in the United States" (May 2025). **This map is a snapshot and is already out of date in places** — Missouri in particular (see below). Treat it as a picture of how *varied* the landscape is, not as a current legal reference. For live status, use the Guttmacher Institute or Center for Reproductive Rights trackers.
:::
...
- Some legal commentators argue *Dobbs* has revived Comstock. The theory is that mifepristone could become functionally unavailable nationwide — without any new law being passed.
...
**The ethics point:** access to the most common method of abortion in the US currently rests on a *stay* — a temporary order — not a settled rule. Ask what it does to clinical practice when the legality of a standard treatment can change between one semester and the next.
:::
