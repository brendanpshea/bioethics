...
::: {.aside-note}
The discomfort comes first and the vocabulary second — deliberately. The history in this chapter is much easier to hold onto if you already feel the problem it was written to answer.
:::
...
::: {.aside-note}
The scoreboard is this chapter's running spine. Each disaster leaves a gap; later, a code fills it. Right now the gap is wide open — watch it close.
:::
...
- Beecher's boldest claim was that the consent form is *not* the real safeguard — consent can be a signature collected on a frightened patient who understands nothing.
