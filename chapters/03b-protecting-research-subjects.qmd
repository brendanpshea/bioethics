...
- For most randomized trials, the standard license is [clinical equipoise]{.key-term} [@freedman1987]
...
- Equipoise is the default moral license for an RCT — but, as we will see, it is a contested one
...
Equipoise is a powerful idea, but it is not the answer to every research-ethics question.

- **Phase I trials don't have arms to compare.** A first-in-human dose-finding study exposes participants to risk for very little personal benefit. There is no equipoise to invoke. The framework is *risk-benefit plus informed consent*.
- **Miller and Brody's critique.** Equipoise treats the trial investigator as if she were the participant's *doctor*, with a duty not to give a worse option. But research aims at knowledge for *future* patients, not care for *this* one. On their view, equipoise quietly imports the therapeutic misconception into the rulebook.
- **Stopping early cuts both ways.** When a monitoring board stops a trial for benefit, equipoise says it must — uncertainty has resolved. But the **public** gets weaker evidence: smaller samples, missed long-term harms, possibly overstated effects. Subject welfare and public knowledge can pull apart.

The takeaway is not that equipoise is wrong. It is that equipoise is the right frame for the *middle* of research ethics — comparative trials of real treatments — and the wrong frame for the edges.
